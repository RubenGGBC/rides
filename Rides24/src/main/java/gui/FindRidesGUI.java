...
public class FindRidesGUI extends JFrame {
    ...
    private final Color HIGHLIGHT_COLOR = new Color(210, 228, 238);
    ...
    private JLabel jLabelHeader = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("FindRidesGUI.FindRides"));
    ...
    public FindRidesGUI() {
        ...
        jLabelEventDate.setBounds(new Rectangle(400, startY - 25, 140, 25));
        jLabelEvents.setBounds(30, startY + 200, 300, 25);
        jLabelEvents.setFont(new Font("Dialog", Font.BOLD, 14));

        this.getContentPane().add(jLabelEventDate, null);
        this.getContentPane().add(jLabelEvents);

        // Style the close button
        jButtonClose.setBounds(new Rectangle(285, startY + 370, 130, 35));
        ...
        jLabelDestination.setBounds(30, startY + 35, 120, 25);
        ...
        jComboBoxOrigin.setBounds(new Rectangle(160, startY, 200, 25));
        ...
        jComboBoxDestination.setBounds(new Rectangle(160, startY + 35, 200, 25));
        jComboBoxDestination.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                paintDaysWithEvents(jCalendar1, datesWithRidesCurrentMonth, HIGHLIGHT_COLOR);
        ...
        jCalendar1.setBounds(new Rectangle(400, startY, 250, 150));
            ...
            public void propertyChange(PropertyChangeEvent propertychangeevent) {
                if (propertychangeevent.getPropertyName().equals("locale")) {
                    ...
                    try {
                        ...
                        BLFacade facade = MainGUI.getBusinessLogic();
                        List<domain.Ride> rides = facade.getRides(
                            (String)jComboBoxOrigin.getSelectedItem(),
                            (String)jComboBoxDestination.getSelectedItem(),
        ...
        // Style the table and scrollpane
        scrollPaneEvents.setBounds(new Rectangle(30, startY + 230, 640, 130));
        scrollPaneEvents.setBorder(BorderFactory.createLineBorder(BLUE_HEADER));
        ...
        // Add a custom header renderer with blue background
        JTableHeader header = tableRides.getTableHeader();
        header.setBackground(BLUE_HEADER);
        header.setForeground(WHITE_TEXT);
